...
<body>
    ...
    <h2>Unidad de Medida: {{$ingrediente->unidadMedida}}</h2>
    ...
    <section id="chefs" class="chefs section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
          <h2>Ingredientes</h2>
          <p>Ver Ingrediente: <span>{{ $ingrediente->nombre}}</span></p>
        </div>
          ...
          <div class=" align-items-stretch" data-aos="fade-up" data-aos-delay="100">
            <div class="chef-member">
              ...
              <div class="member-info">
                <h4>{{ $ingrediente->nombre}}</h4><br>
                    <h5 style="font-size: 10px;">Cantidad: <span>{{ $ingrediente->cantidad}}</span><h5>
                    @if ($ingrediente->unidadMedida)
                        <h5 style="font-size: 10px;">Unidad de medida: <span>{{ $ingrediente->unidadMedida }}</span></h5>
                    @endif   
