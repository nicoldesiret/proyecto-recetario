...
<div class="section-header">
          <p>Actualiza tu <span>comentario</span></p>
        </div> 
...
<section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        @csrf 
        @method('PATCH')
        <h2 style="font-weight: bold; font-size: 30px; color: black;" >Edita comentario</h2>
            <div class="row">
        ...
        <div class="form-group">
            <label style="font-weight: bold; color: black;" for="calificacion">Calificación:</label>
    ...
    <button type="submit" style="display: inline-block; padding: 10px 20px; background-color: red; color: white; border: none; border-radius: 20px; cursor: pointer;">Actualizar</button>
        </div>
